...
struct StringTests {
    ...
    @Test func test_dataUsingEncoding_preservingBOM() {
    ...
    @Test func test_dataUsingEncoding_ascii() {
    ...
    @Test func test_pathHasDotDotComponent() {
    ...
    @Test func test_init_contentsOfFile_encoding() throws {
    ...
    @Test func test_init_contentsOfFile_usedEncoding() throws {
        try withTemporaryStringFile { existingURL, nonExistentURL in
    ...
    @Test func test_init_contentsOf_encoding() throws {
        try withTemporaryStringFile { existingURL, nonExistentURL in
    ...
    @Test func test_init_contentsOf_usedEncoding() throws {
#if FOUNDATION_FRAMEWORK
    ...
    @Test func test_extendedAttributeData() {
    ...
    @Test func test_write_toFile() throws {
        try withTemporaryStringFile { existingURL, nonExistentURL in
    ...
    @Test func test_write_to() throws {
        try withTemporaryStringFile { existingURL, nonExistentURL in
            let nonExistentPath = nonExistentURL.path()
            let s = "Lorem ipsum dolor sit amet, consectetur adipisicing elit"
...
struct StringTestsStdlib {
    ...
    @Test func test_completePath() throws {
        try withTemporaryStringFile { existingURL, nonExistentURL in
