...
final class DataTests {
    ...
    @Test func testCopyBytes_fromSubSequenceToGenericBuffer() {
    ...
    @Test func test_splittingHttp() throws {
...
extension DataTests {
    ...
    @Test func testEOPNOTSUPP() throws {
...
extension DataTests {
    ...
    @Test func test_rangeOfSlice() throws {
