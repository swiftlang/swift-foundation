...
struct BufferViewTests {
    ...
    @Test func testInitBufferViewOrdinaryElement() {
        let capacity = 4
    ...
    @Test func testInitBitwiseCopyableElement() {
        let capacity = 4
    ...
    @Test func testIteratorBitwiseCopyable() {
        let count = 4
        let offset = 1
    ...
    @Test func testBufferViewSequence() {
        let capacity = 4
        let a = Array(0..<capacity)
    ...
    @Test func testBufferViewIndices() {
        let capacity = 4
        let a = Array(0..<capacity)
        a.withUnsafeBufferPointer {
            let view = BufferView(unsafeBufferPointer: $0)!
    ...
    @Test func testIndexManipulation() {
        let capacity = 4
        let a = Array(0..<capacity)
        a.withUnsafeBufferPointer {
    ...
    @Test func testIndexingSubscript() {
        let capacity = 4
        let a = Array(0..<capacity)
        a.withUnsafeBufferPointer {
            let v = BufferView(unsafeBufferPointer: $0)!
    ...
    @Test func testRangeOfIndicesSubscript() {
        let capacity = 4
    ...
    @Test func testWithUnsafePointer() {
    ...
    @Test func testWithUnsafeBuffer() {
        let capacity: UInt8 = 64
        let a = Array(0..<capacity)
        a.withUnsafeBufferPointer {
            ub in
