...
var globalSeed: Int {
    // Disable randomized testing until we have a stdlib that includes
    // https://github.com/apple/swift/pull/63043.
#if RANDOMIZED_TESTING
    42.hashValue
#else
    0
#endif
...
public struct RepeatableRandomNumberGenerator: RandomNumberGenerator {
  ...
  public init(seed: UInt64) {
    ...
    let global = UInt64(truncatingIfNeeded: globalSeed)
