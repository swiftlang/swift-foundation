...
private struct AttributedStringIndexTrackingTests {
    ...
    func basics() throws {
        ...
        let updatedRanges = try #require(
            text.transform(updating: [helloRange, worldRange]) {
    ...
    func insertionAtStartOfRange() throws {
        ...
        let updatedHelloRange = try #require(
            text.transform(updating: helloRange) {
    ...
    func insertionAtEmptyRange() throws {
        ...
        let updatedRange = try #require(
            text.transform(updating: idx..<idx) {
    ...
    func trackingLost() throws {
        ...
        do {
            var copy = text
            #expect(
                copy.transform(updating: helloRange) {
                    $0 = AttributedString("Foo")
                } == nil)
        }
