...
private struct NumberFormatStyleTests {
    ...
    let testNegativePositiveDecimalData: [Decimal] = [
        Decimal(string: "87650")!, Decimal(string: "8765")!, Decimal(string: "876.5")!, Decimal(string: "87.65")!, Decimal(string: "8.765")!, Decimal(string: "0.8765")!, Decimal(string: "0.08765")!, Decimal(string: "0.008765")!,
        Decimal(string: "0")!, Decimal(string: "-0.008765")!, Decimal(string: "-876.5")!, Decimal(string: "-87650")!,
    ]
    ...
    @Test func floatingPointFormatStyle() throws {
        ...
        _testNegativePositiveDouble(
            style.precision(.integerAndFractionLength(integerLimits: 0...0, fractionLimits: 2...2)), ["87,650.00", "8,765.00", "876.50", "87.65", "8.76", ".88", ".09", ".01", ".00", "-.01", "-876.50", "-87,650.00"], "exact 2 integer digits")
    }
    ...
    @Test func floatingPointFormatStyle_BigNumber() throws {
        ...
        #expect(
            Float64.greatestFiniteMagnitude.formatted(.number.locale(enUSLocale))
        ...
        #expect(
            Float64.greatestFiniteMagnitude.formatted(.percent.locale(enUSLocale))
        ...
        #expect(
            Float64.greatestFiniteMagnitude.formatted(.currency(code: "USD").locale(enUSLocale))
    ...
    @Test func decimalFormatStyle_Percent() throws {
        ...
        _testNegativePositiveDecimal(
            style.precision(.fractionLength(1...3)),
            [
                "8,765,000.0%",
                "876,500.0%",
                "87,650.0%",
        ...
        _testNegativePositiveDecimal(
            style.precision(.integerLength(3...)),
            [
                "8,765,000%",
                "876,500%",
                "87,650%",
        ...
        _testNegativePositiveDecimal(
            style.precision(.integerLength(1...3)),
            [
                "0%",
                "500%",
                "650%",
                ...
                "-650%",
                "-0%",
            ], "min 1 max 3 integer digits")
        _testNegativePositiveDecimal(
            style.precision(.integerLength(2...2)),
            [
                "00%",
                "00%",
                "50%",
    ...
    @Test func decimalFormatStyle_Currency_groupingWithRounding() throws {
        ...
        _testNegativePositiveDecimal(
            style.rounded(rule: .toNearestOrEven).grouping(.never), ["$87650.00", "$8765.00", "$876.50", "$87.65", "$8.76", "$0.88", "$0.09", "$0.01", "$0.00", "-$0.01", "-$876.50", "-$87650.00"], "currency rounded + grouping(.never)")
        _testNegativePositiveDecimal(
            style.grouping(.never).rounded(rule: .toNearestOrEven), ["$87650.00", "$8765.00", "$876.50", "$87.65", "$8.76", "$0.88", "$0.09", "$0.01", "$0.00", "-$0.01", "-$876.50", "-$87650.00"], "currency grouping(.never) + rounded")
    }
...
private struct IntegerFormatStyleExhaustiveTests {
    let exhaustiveIntNumbers: [Int64] = [
        9223372036854775807, 922337203685477580, 92233720368547758, 9223372036854775, 922337203685477, 92233720368547, 9223372036854, 922337203685, 92233720368, 9223372036, 922337203, 92233720, 9223372, 922337, 92233, 9223, 922, 92, 9, 0, -9,
        -92, -922, -9223, -92233, -922337, -9223372, -92233720, -922337203, -9223372036, -92233720368, -922337203685, -9223372036854, -92233720368547, -922337203685477, -9223372036854775, -92233720368547758, -922337203685477580,
        -9223372036854775808,
    ]
    ...
    @Test func test_plainStyle_signStrategy() throws {
        let expectations: [IntegerFormatStyle<Int>: [String]] = [
            ...
            baseStyle.sign(strategy: .always(includingZero: false)): [
                "+9,223,372,036,854,775,807",
                "+922,337,203,685,477,580",
                "+92,233,720,368,547,758",
                "+9,223,372,036,854,775",
            ...
            baseStyle.sign(strategy: .always(includingZero: true)): [
                "+9,223,372,036,854,775,807",
                "+922,337,203,685,477,580",
                "+92,233,720,368,547,758",
                "+9,223,372,036,854,775",
    ...
    @Test func plainStyle_rounded() throws {
        let expectations: [IntegerFormatStyle<Int>: [String]] = [
            baseStyle.rounded(rule: .toNearestOrEven, increment: 5): [
            ...
            baseStyle.rounded(rule: .toNearestOrEven, increment: 100): [
                "9,223,372,036,854,775,800",
...
private struct NumberAttributedFormatStyleTests {
    ...
    @Test func floatingPoint() throws {
        ...
        let value = -3000.14
        #expect(style.attributed.format(value) == [("-", nil, .sign), ("3", .integer, nil), (",", .integer, .groupingSeparator), ("000", .integer, nil), (".", nil, .decimalSeparator), ("14", .fraction, nil)].attributedString)
        #expect(
            style.precision(.fractionLength(3...3)).attributed.format(value)
                == [("-", nil, .sign), ("3", .integer, nil), (",", .integer, .groupingSeparator), ("000", .integer, nil), (".", nil, .decimalSeparator), ("140", .fraction, nil)].attributedString)
        #expect(style.grouping(.never).attributed.format(value) == [("-", nil, .sign), ("3000", .integer, nil), (".", nil, .decimalSeparator), ("14", .fraction, nil)].attributedString)

        let percent: FloatingPointFormatStyle<Double>.Percent = .init(locale: enUS)
        #expect(percent.attributed.format(value) == [("-", nil, .sign), ("300", .integer, nil), (",", .integer, .groupingSeparator), ("014", .integer, nil), ("%", nil, .percent)].attributedString)

        let currency: FloatingPointFormatStyle<Double>.Currency = .init(code: "EUR", locale: Locale(identifier: "zh_TW"))
        #expect(currency.grouping(.never).attributed.format(value) == [("-", nil, .sign), ("€", nil, .currency), ("3000", .integer, nil), (".", nil, .decimalSeparator), ("14", .fraction, nil)].attributedString)
        #expect(
            currency.presentation(.fullName).attributed.format(value)
...
private struct FormatStylePatternMatchingTests {
    ...
    @Test func matchPartialRange_Number() {
        ...
        _match(
            string, decimalStyle, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345"
        _match(
            string, decimalStyle, range: 0..<7,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345,"

        _match(
            string, decimalStyle, range: 0..<10,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678"
        _match(
            string, decimalStyle, range: 0..<11,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678,"

        _match(
            string, decimalStyle, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678"
        _match(
            string, decimalStyle, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678,"

        // Test starting at non-zero position
        _match(
            string, decimalStyle, startingAt: 1, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 2345) // "2,345"
        _match(
            string, decimalStyle, startingAt: 3, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 345) // "345"

        _match(
            string, decimalStyle, startingAt: 7, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 678) // "678"
        _match(
            string, decimalStyle, startingAt: 7, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 678) // "678,"
        ...
        */
        ...
        _match(
            string, intStyle, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345"
        _match(
            string, intStyle, range: 0..<7,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345,"

        _match(
            string, intStyle, range: 0..<10,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678"
        _match(
            string, intStyle, range: 0..<11,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678,"

        _match(
            string, intStyle, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678"
        _match(
            string, intStyle, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678,"

        // Test starting at non-zero position
        _match(
            string, intStyle, startingAt: 1, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 2345) // "2,345"
        _match(
            string, intStyle, startingAt: 3, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 345) // "345"

        _match(
            string, intStyle, startingAt: 7, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 678) // "678"
        _match(
            string, intStyle, startingAt: 7, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 678) // "678,"

        _match(
            string, floatStyle, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345"
        _match(
            string, floatStyle, range: 0..<7,
            expectedUpperBound: 6, expectedValue: 12345) // "12,345,"

        _match(
            string, floatStyle, range: 0..<10,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678"
        _match(
            string, floatStyle, range: 0..<11,
            expectedUpperBound: 10, expectedValue: 12345678) // "12,345,678,"

        _match(
            string, floatStyle, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678"
        _match(
            string, floatStyle, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 345678) // "345,678,"

        // Test starting at non-zero position
        _match(
            string, floatStyle, startingAt: 1, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 2345) // "2,345"
        _match(
            string, floatStyle, startingAt: 3, range: 0..<6,
            expectedUpperBound: 6, expectedValue: 345) // "345"

        _match(
            string, floatStyle, startingAt: 7, range: 3..<10,
            expectedUpperBound: 10, expectedValue: 678) // "678"
        _match(
            string, floatStyle, startingAt: 7, range: 3..<11,
            expectedUpperBound: 10, expectedValue: 678) // "678,"
...
extension FormatStylePatternMatchingTests {
    ...
    ) where Consumer.RegexOutput == Value {
