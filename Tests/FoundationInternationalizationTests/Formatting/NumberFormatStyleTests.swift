...
struct NumberFormatStyleTests {
    ...
    @Test func testNSICUNumberFormatter() throws {
    ...
    @Test func testNSICUNumberFormatterCache() throws {
    ...
    @Test func testIntegerFormatStyle() throws {
        ...
        func testIntValues(_ style: IntegerFormatStyle<Int>, expected: [String], sourceLocation: SourceLocation = #_sourceLocation) {
            for i in 0..<testData.count {
                #expect(style.format(testData[i]) == expected[i])
            }
        }
    ...
    @Test func testIntegerFormatStyleFixedWidthLimits() throws {
    ...
    @Test func testInteger_Precision() throws {
    ...
    @Test func testIntegerFormatStyle_Percent() throws {
    ...
    @Test func testIntegerFormatStyle_Currency() throws {
    ...
    @Test func testFloatingPointFormatStyle_Percent() throws {
    ...
    @Test func testFloatingPointFormatStyle_BigNumber() throws {
    ...
    @Test func testFormattedAttributedLeadingDotSyntax() throws {
        let int = 42
    ...
    @Test func testDecimalFormatStyle() throws {
    ...
    @Test func testDecimalFormatStyle_Percent() throws {
    ...
    @Test func testDecimalFormatStyle_Currency() throws {
    ...
    @Test func testCurrency_compactName() throws {
    ...
    @Test func testCurrency_scientific() throws {
...
extension CurrentLocaleTimeZoneCalendarDependentTests {
    struct NumberFormatStyleTests {
        @Test(.enabled(if: Locale.autoupdatingCurrent.language.isEquivalent(to: Locale.Language(identifier: "en_US")), "This test can only be run with the system set to the en_US language"))
        func testDecimal_withCustomShorthand() {
        ...
        @Test(.enabled(if: Locale.autoupdatingCurrent.language.isEquivalent(to: Locale.Language(identifier: "en_US")), "This test can only be run with the system set to the en_US language"))
        func testDecimal_withShorthand_enUS() {
        ...
        @Test func testDecimal_default() throws {
        ...
        @Test func testDecimal_withShorthand() throws {
            let style = Decimal.FormatStyle()
            #expect((12345 as Decimal).formatted(.number) == style.format(12345))
            #expect((12345.678 as Decimal).formatted(.number) == style.format(12345.678))
            #expect((0 as Decimal).formatted(.number) == style.format(0))
            #expect((3.14159 as Decimal).formatted(.number) == style.format(3.14159))
            #expect((-3.14159 as Decimal).formatted(.number) == style.format(-3.14159))
            #expect((-3000.14159 as Decimal).formatted(.number) == style.format(-3000.14159))
            
            let percentStyle = Decimal.FormatStyle.Percent()
            #expect((12345 as Decimal).formatted(.percent) == percentStyle.format(12345))
            #expect((12345.678 as Decimal).formatted(.percent) == percentStyle.format(12345.678))
            #expect((0 as Decimal).formatted(.percent) == percentStyle.format(0))
            #expect((3.14159 as Decimal).formatted(.percent) == percentStyle.format(3.14159))
            #expect((-3.14159 as Decimal).formatted(.percent) == percentStyle.format(-3.14159))
            #expect((-3000.14159 as Decimal).formatted(.percent) == percentStyle.format(-3000.14159))
            
            let currencyStyle = Decimal.FormatStyle.Currency(code: "USD")
            #expect((12345 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(12345))
            #expect((12345.678 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(12345.678))
            #expect((0 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(0))
            #expect((3.14159 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(3.14159))
            #expect((-3.14159 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(-3.14159))
            #expect((-3000.14159 as Decimal).formatted(.currency(code:"USD")) == currencyStyle.format(-3000.14159))
        }
        
#if FOUNDATION_FRAMEWORK
        @Test func test_autoupdatingCurrentChangesFormatResults() {
...
struct IntegerFormatStyleExhaustiveTests {
    ...
    @Test func testIntegerLongStyles() throws {
    ...
    @Test func testEquivalentStyles() throws {
    ...
    @Test func test_plainStyle_scale() throws {
    ...
    @Test func test_plainStyle_rounded() throws {
        let expectations: [IntegerFormatStyle<Int> : [String]] = [
    ...
    @Test func test_plainStyle_rounded_largeIncrement() {
    ...
    @Test func test_plainStyle_scientific() throws {
        let expectations: [IntegerFormatStyle<Int> : [String]] = [
    ...
    @Test func test_plainStyle_compactName() throws {
        let expectations: [IntegerFormatStyle<Int> : [String]] = [
            // `compactName` naturally rounds the number to the closest "name".
...
struct TestNumberAttributeFormatStyle {
    let enUS = Locale(identifier: "en_US")
    let frFR = Locale(identifier: "fr_FR")

    @Test func testIntegerStyle() throws {
    ...
    @Test func testIntegerStyle_Currency() throws {
    ...
    @Test func testIntegerStyle_Percent() throws {
    ...
    @Test func testFloatingPoint() throws {
        let style = FloatingPointFormatStyle<Double>(locale: enUS)
        let value = -3000.14
        ...
        let percent = FloatingPointFormatStyle<Double>.Percent(locale: enUS)
        ...
        let currency = FloatingPointFormatStyle<Double>.Currency(code: "EUR", locale: Locale(identifier: "zh_TW"))
    ...
    @Test func testDecimalStyle() throws {
    ...
    @Test func testSettingLocale() throws {
        let int = 42000
...
struct FormatStylePatternMatchingTests {
    let frFR = Locale(identifier: "fr_FR")
    let enUS = Locale(identifier: "en_US")

    typealias TestCase = (string: String, style: IntegerFormatStyle<Int>, value: Int?)

    @Test func testIntegerFormatStyle_Consumer() {
    ...
    @Test func testPercentFormatStyle_Consumer() {
    ...
    @Test func testCurrencyFormatStyle_Consumer() {
        ...
        // Different locale
        let frenchStyle = IntegerFormatStyle<Int>.Currency(code: "EUR", locale: frFR)
    ...
    @Test func testMatchPartialRange_Number() {
    ...
    @Test func testGreedyMatchPartialRange() {
        let style = Decimal.FormatStyle(locale: enUS)
...
extension NumberFormatStyleTests {
    @Test func testFormattedLeadingDotSyntax() {
        let integer = 12345
...
extension NumberFormatStyleTests {
    ...
    @Test func testIntegerFormatStyleBigNumberNoCrash() throws {
