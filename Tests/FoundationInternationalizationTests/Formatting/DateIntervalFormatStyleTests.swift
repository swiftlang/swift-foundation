...
final class DateIntervalFormatStyleTests: XCTestCase {
    ...
    func testBasicFormatStyle() throws {
        ...
        XCTAssertEqual(style.format(date..<date + hour), "1/1/2001, 12:00 – 1:00 AM")
        XCTAssertEqual(style.format(date..<date + day), "1/1/2001, 12:00 AM – 1/2/2001, 12:00 AM")
        XCTAssertEqual(style.format(date..<date + day * 32), "1/1/2001, 12:00 AM – 2/2/2001, 12:00 AM")
        ...
        XCTAssertEqual(timeStyle.format(date..<date + hour), "12:00:00 AM – 1:00:00 AM")
        XCTAssertEqual(timeStyle.format(date..<date + day), "1/1/2001, 12:00:00 AM – 1/2/2001, 12:00:00 AM")
        XCTAssertEqual(timeStyle.format(date..<date + day * 32), "1/1/2001, 12:00:00 AM – 2/2/2001, 12:00:00 AM")
        ...
        XCTAssertEqual(dateTimeStyle.format(date..<date + hour), "1/1/2001, 12:00 – 1:00 AM")
        XCTAssertEqual(dateTimeStyle.format(date..<date + day), "1/1/2001, 12:00 AM – 1/2/2001, 12:00 AM")
        XCTAssertEqual(dateTimeStyle.format(date..<date + day * 32), "1/1/2001, 12:00 AM – 2/2/2001, 12:00 AM")
    }
    ...
    func testCustomFields() throws {
        ...
        XCTAssertEqual(timeStyle.format(date..<date + hour * 0.5), "12 AM GMT")
        XCTAssertEqual(timeStyle.format(date..<date + hour), "12 – 1 AM GMT")
        XCTAssertEqual(timeStyle.format(date..<date + hour * 1.5), "12 – 1 AM GMT")
        // The date interval range (day) is larger than the specified unit (hour), so ICU fills the missing day parts to ambiguate.
        XCTAssertEqual(timeStyle.format(date..<date + day), "1/1/2001, 12 AM GMT – 1/2/2001, 12 AM GMT")
        XCTAssertEqual(timeStyle.format(date..<date + day * 32), "1/1/2001, 12 AM GMT – 2/2/2001, 12 AM GMT")
        ...
        XCTAssertEqual(weekDayHourStyle.format(date..<date + hour), "Mon, 12 – 1 AM")
        XCTAssertEqual(weekDayHourStyle.format(date..<date + day), "Mon 1, 12 AM – Tue 2, 12 AM")
        XCTAssertEqual(weekDayHourStyle.format(date..<date + day * 32), "Mon, 1/1, 12 AM – Fri, 2/2, 12 AM")
    }
    ...
    func testStyleWithCustomFields() throws {
        ...
        XCTAssertEqual(dateHourStyle.format(date..<date + hour), "1/1/2001, 12 – 1 AM")
        XCTAssertEqual(dateHourStyle.format(date..<date + day), "1/1/2001, 12 AM – 1/2/2001, 12 AM")
        XCTAssertEqual(dateHourStyle.format(date..<date + day * 32), "1/1/2001, 12 AM – 2/2/2001, 12 AM")
        ...
        XCTAssertEqual(timeMonthDayStyle.format(date..<date + hour), "1/1, 12:00 – 1:00 AM")
        XCTAssertEqual(timeMonthDayStyle.format(date..<date + day), "1/1, 12:00 AM – 1/2, 12:00 AM")
        XCTAssertEqual(timeMonthDayStyle.format(date..<date + day * 32), "1/1, 12:00 AM – 2/2, 12:00 AM")
