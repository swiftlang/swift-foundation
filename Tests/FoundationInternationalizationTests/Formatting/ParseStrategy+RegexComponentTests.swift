...
struct ParseStrategyMatchTests {
    ...
    @Test func testAPIHTTPHeader() throws {
...
"""
    ...
    @Test func testAPITestSuites() throws {
    ...
    @Test func testVariousDatesAndTimes() {
    ...
    @Test func testMatchISO8601String() {
