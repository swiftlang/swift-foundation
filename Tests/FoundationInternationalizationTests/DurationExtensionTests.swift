...
private struct DurationExtensionTests {
    ...
    @Test func roundingMode() {
        ...
        verify(
            [9223372036854775018, 18, 15, 12, 8, 5, 2, 0], increment: 10,
            expected: [
        ...
        verify(
            [-2, -5, -8, -12, -15, -18, -9223372036854775018], increment: 10,
            expected: [
        ...
        verify(
            [9223372036854775018, 18, 15, 12, 8, 5, 2, 0], increment: 5,
            expected: [
        ...
        verify(
            [-2, -5, -8, -12, -15, -18, -9223372036854775018], increment: 5,
            expected: [
        ...
        verify(
            [9223372036854775018, 18, 15, 12, 8, 5, 2, 0], increment: 9223372036854775807,
            expected: [
