...
let benchmarks: @Sendable () -> Void = {
    ...
    #if FOUNDATION_FRAMEWORK
    Benchmark(
        "insertIntoLongString-objc",
        closure: { benchmark, strNS in
            autoreleasepool {
    ...
    Benchmark(
        "replaceSubrangeOfLongString-swift",
        closure: { benchmark, box in
            for _ in benchmark.scaledIterations {
    ...
    #if FOUNDATION_FRAMEWORK
    Benchmark(
        "replaceSubrangeOfLongString-objc",
        closure: { benchmark, strs in
            autoreleasepool {
