...
package struct LocalePreferences: Hashable, Sendable {
    package enum MeasurementUnit: Int, Codable {
        ...
        init?(_ string: String?) {
            ...
            if string == "Centimeters" { self = .centimeters } else if string == "Inches" { self = .inches } else { return nil }
        }
    ...
    package enum TemperatureUnit: Int, Codable {
        ...
        init?(_ string: String?) {
            guard let string else { return nil }
            if string == "Celsius" { self = .celsius } else if string == "Fahrenheit" { self = .fahrenheit } else { return nil }
        }
