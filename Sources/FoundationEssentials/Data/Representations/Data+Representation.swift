...
extension Data {
    ...
    internal struct _Representation : Sendable {
        ...
        @_alwaysEmitIntoClient @inline(__always) // This is @inlinable as a trivial initializer.
        ...
        @_alwaysEmitIntoClient @inline(__always) // This is @inlinable as trivially computable (and inlining may help avoid retain-release traffic).
        ...
        mutating func reserveCapacity(_ minimumCapacity: Int) {
            ...
            _storage.ensureUniqueBufferReference(growingTo: Swift.max(minimumCapacity, count))
        }
        ...
        var count: Int {
            ...
            set(newValue) {
                ...
                if difference > 0 {
                    let additionalRange = _slice.upperBound ..< (_slice.upperBound + difference)
        ...
        @_alwaysEmitIntoClient @inline(__always) // This is @inlinable as a generic, trivially forwarding function.
        ...
        @_alwaysEmitIntoClient @inline(__always) // This is @inlinable as trivially forwarding.
        var startIndex: Int {
            _slice.lowerBound
        }
