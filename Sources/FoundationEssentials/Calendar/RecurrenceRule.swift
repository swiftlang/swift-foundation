extension Calendar {
    ...
    public struct RecurrenceRule: Sendable, Equatable {
        ...
        public enum RepeatedTimePolicy: String, Sendable, Codable {
            /// Consider only the earlier date
            case onlyFirst = "onlyFirst"
            /// Consider only the later date
            case onlyLast = "onlyLast"
            /// Consider both dates
            case both = "both"
        }
        ...
        public enum Frequency: String, Sendable, Codable, Equatable {
