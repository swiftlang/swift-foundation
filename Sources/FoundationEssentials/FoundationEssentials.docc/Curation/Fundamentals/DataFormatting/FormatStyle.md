# ``/FoundationEssentials/FormatStyle``
...
- ``iso8601-1jmw1`` <!-- static var iso8601: DateComponents.ISO8601FormatStyle { get } -->
- ``iso8601-2hxhp`` <!-- static var iso8601: Date.ISO8601FormatStyle { get } -->
- ``Date/8601FormatStyle``
- ``http-26iub``    <!-- static var http: Date.HTTPFormatStyle { get } -->
- ``http-3z94y``    <!-- static var http: DateComponents.HTTPFormatStyle { get } -->
